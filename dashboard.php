...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="form-inline my-2 my-lg-0 mr-5" method="POST">
        <input class="form-control mr-sm-2 " id="search_field" autocomplete="off"  type="search" placeholder="Search" aria-label="Search" name="search_area">
  ...
  <div id="show_search" class="alert alert-secondary" style="font-family:verdana;width:300px;position:absolute;left:72%;top:7%;"></div>
                    ...
                    <div class='col-md-8'>
                      <div class='card-body text-center'>
                        ...
                        <p class='card-text'>
                          ...
                          <a href='product_details.php?product_id=$show_pro_id' class='nav-link mt-3'>View Product</a>
                        </p>
    ...
    <a href="chat_page.php"><img src="images/msg_icon.jpg" style="box-shadow:10px 5px 10px 5px #888888;border-radius:200px;" class="fixed-bottom mb-3 ml-3" alt="chat-icon" width=100></a>
